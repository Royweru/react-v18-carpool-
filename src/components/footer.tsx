...
export const Footer = () => {
  return (
    <footer className=" bg-zinc-950 dark:bg-white dark:border-black border-gray-800 border-t-[0.5px] rounded-t-lg">
    <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
            <a href="#">
                <img className="w-auto h-20" src="https://images.unsplash.com/photo-1517026575980-3e1e2dedeab4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y2FyJTIwdHJhZGluZyUyMGFnZW5jeSUyMGxvZ298ZW58MHx8MHx8fDA%3D"  alt=""/>
            </a>
            ...
            <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
                ...
                <path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C21.9939 17.5203 17.5203 21.9939 12 22ZM4 12.172C4.04732 16.5732 7.64111 20.1095 12.0425 20.086C16.444 20.0622 19.9995 16.4875 19.9995 12.086C19.9995 7.68451 16.444 4.10977 12.0425 4.086C7.64111 4.06246 4.04732 7.59876 4 12V12.172ZM10 16.5V7.5L16 12L10 16.5Z" fill="currentColor"></path>
                    ...
                    <span className="mx-1">Browse our stock</span>
                </button>

                <button className="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Find your car</button>
            </div>
        </div>
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <p className="text-sm text-gray-500">© Carpool 2024. All Rights Reserved.</p>
